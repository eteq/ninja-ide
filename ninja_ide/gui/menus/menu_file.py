...
###############################################################################
    ...
    def __init__(self, menuFile, toolbar, ide):
        ...
        printFile = menuFile.addAction(QIcon(resources.IMAGES['print']),
            self.trUtf8(u"Pr&int File ({0})".format( 
        ...
        closeAction = menuFile.addAction(
            ...
            self.trUtf8(u"&Close Tab ({0})".format( 
